...
// so you must consider 's left of all higher digits in your tests. For example  is valid,  is not.

// Given a string representing the starting number, and a maximum number of changes allowed, 
// create the largest palindromic string of digits possible or the string '-1' 
